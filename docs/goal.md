Goal
- Ensure this branch implements a per-project AppArmor-first setup per security docs and make bonesremote doctor validate AppArmor and per-site nginx wiring correctly.

Constraints & Preferences
- Read and follow ./docs/PROJECT.md, ./docs/security/*, and ./docs/commands/*.
- In-scope: AppArmor implementation/policy alignment and per-site nginx wiring.
- Out-of-scope: Landlock-specific runtime isolation.
- User decision: doctor must enforce/check AppArmor-first and per-site nginx wiring.
...
- Identified drift/conflict: command docs still showed primary runtime isolation paths conflicting with AppArmor-first intent.
...
- Updated docs: docs/commands/bonesremote/doctor.md now documents AppArmor checks and updated summary table.
...
Key Decisions
- bonesremote doctor should perform AppArmor-first validation and per-site nginx wiring validation.
...
- /Users/alexyounger/Development/Code/Rust/bonesdeploy/.worktrees/feat/apparmor/docs/security/22-desired-end-state-summary.md: desired end-state includes AppArmor enforcing and seccomp where practical.
- /Users/alexyounger/Development/Code/Rust/bonesdeploy/.worktrees/feat/apparmor/crates/bonesremote/src/commands/doctor.rs: implemented AppArmor doctor checks and unit tests.
...
- /Users/alexyounger/Development/Code/Rust/bonesdeploy/.worktrees/feat/apparmor/kit/remote/nginx/site-nginx.service.j2: per-site nginx systemd service with AppArmor and systemd sandboxing.
